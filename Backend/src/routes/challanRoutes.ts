...
challanRouter.get("/", authorize(["ADMIN", "SALES", "ACCOUNTS"]), asyncHandler(listChallans));
challanRouter.post("/", authorize(["ADMIN", "SALES"]), asyncHandler(createChallan));
challanRouter.get("/:challanId", authorize(["ADMIN", "SALES", "ACCOUNTS"]), asyncHandler(getChallan));
challanRouter.put("/:challanId", authorize(["ADMIN", "SALES"]), asyncHandler(updateChallan));
challanRouter.post("/:challanId/confirm", authorize(["ADMIN", "SALES"]), asyncHandler(confirmChallan));
